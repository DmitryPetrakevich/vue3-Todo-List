<template>
    <div class="pomodoro-controls">
        ...
        <svg fill="currentColor" width="60px" height="60px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg"
         class="pomodoro-controls-btn" @click="$emit('show-reset-model')"
        >
            <path
